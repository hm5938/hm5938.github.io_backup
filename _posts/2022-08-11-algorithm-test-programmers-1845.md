...
tags: algorithm programmers 1845
comments: false
---
### **문제 설명**
...
[제목 없음](https://www.notion.so/e858a4ac63b248fba245c5af22f1283f)
...
1. int[]를 hashset으로 변환하여 중복을 제거해준다.
2. 만약 폰켓몬 종류가 폰켓몬 수의 절반이 넘는다면 절반의 수를 리턴해주고, 아니라면 폰켓몬의 종류의 수 를 리턴해준
