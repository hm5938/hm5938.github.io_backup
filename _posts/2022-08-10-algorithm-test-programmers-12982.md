...
tags: algorithm programmers 12982
comments: false
---
### **문제 설명**
...
[제목 없음](https://www.notion.so/1ab287d8aba049e3b90016105d1e82fe)
...
1. 각 부서가 신청한 금액을 오름차순으로 정렬한다.
2. 가격이 낮은 순으로 주어진 예산에서 빼준다.
3. 예산 초과시 지금까지 지원한 부서갯수를 반환한다.
